...
public class UserTests2 {
	...
	public void testGetUser() {
		...
		Response response = UserEndPoints2.readUser(userData.getUsername());
		response.then().log().all();
		JsonPath jsonPath = response.jsonPath();
	...
	public void testUpdateUserByName() {
		...
		Response response = UserEndPoints2.updateUser(userData, userData.getUsername());
		response.then().log().all();
		JsonPath jsonPath = response.jsonPath();
		...
		Response responseAfterUpdate = UserEndPoints2.readUser(userData.getUsername());
